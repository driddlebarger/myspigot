...
#Add outer part of geojson format, put @geojson in as a hash value
  ...
  def create
    ...
    respond_to do |format|
      if @location.save
        ...
        format.html { redirect_to @location, notice: 'WaterSpot added! Check it out:' }
      else
  ...
  private
    ...
    def location_params
      params.require(:location).permit(:name, :description, :latitude, :longitude, :nearby_restroom, :submitted_by)
    end
end
